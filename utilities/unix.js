...
var MONTHS = ['Jan', 'Feb', 'Márc', 'Ápr', 'Máj', 'Jún', 'Júl', 'Aug', 'Szept', 'Okt', 'Nov', 'Dec'];
    ...
    value: function _distanceOfTimeInWords(date, compare_to) {
      ...
      if (this.props.precision == 1) {
        ...
        if (seconds > YEAR) {
          ...
          when.push(distance + ' ' + plural('év', distance));
        ...
        if (seconds > MONTH) {
          ...
          when.push(distance + ' ' + plural('hónap', distance));
        ...
        if (seconds > DAY) {
          ...
          when.push(distance + ' ' + plural('nap', distance));
        ...
        if (seconds > HOUR) {
          ...
          when.push(distance + ' ' + plural('óra', distance));
        ...
        if (seconds > MINUTE) {
          ...
          when.push(distance + ' ' + plural('perc', distance));
          seconds -= distance * MINUTE;
        }

        if (seconds > 0) {
          when.push(seconds + ' ' + plural('másodperc', seconds));
        }
