...
export default class ReceptekHTML extends Component<{}> {
  constructor(props) {
    ...
    this.y_translate = new Animated.Value(-300);
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {" "}
                Engedd meg, hogy az alábbi témához ajánljunk neked jó minőségű
  ...
  pictureHide() {
    var { height, width } = Dimensions.get("window");
    console.log(this.state.content.imageUrl);

    if (this.state.imageUrl != "http://46.101.62.53/Apps/rest/image/null") {
      return (
        <Image
          key={Math.random()}
          resizeMode="cover"
      ...
      <View style={styles.container}>
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <TouchableOpacity
              onPress={() => {
                Actions.gyik({ tesztak: 296 });
              }}
              style={{ zIndex: 2321121321 }}
            >
              <View
                style={{
                  justifyContent: "center",
