...
export default class Keszenall extends Component<{}> {
  constructor(props) {
    super(props);
    this.state = {
      postCover: [],
  ...
  componentWillMount() {
    api.getKeszenall().then(keszenall => {
      this.setState({
        keszenall: keszenall.list
  ...
  render() {
    ...
    console.log(this.state.keszenall);
    return (
      <View style={styles.container}>
        ...
        <View>
          <Image
            source={require("../src/hozzataplalas/hozzatapl_n_keszenall.png")}
        ...
        >
          <ListView
            dataSource={this.dataSource.cloneWithRows(this.state.keszenall)}
