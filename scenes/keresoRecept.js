...
export default class Bevasarlas extends Component<{}> {
    ...
    return (
      ...
      >
        ...
        >
          <Text
            numberOfLines={2}
            style={{ color: "#1DB7AB", textAlign: "center" }}
          >
            {item.name}
          </Text>
        </View>
  ...
  keresoend() {
    ...
    console.log(tags);
    Actions.keresoReceptEnd({ alapanyag: tags });
  }
      ...
      return (
        ...
        >
          ...
          >
            ...
            <TouchableOpacity onPress={() => Actions.kereso()}>
              <View>
            ...
            <Text style={styles.HOME}>{"Recept keresése"}</Text>
          </View>
          <Search
            ref="search_box"
            onChangeText={text => {
          ...
          >
            <TouchableOpacity onPress={() => this.keresoend()}>
              <View
                style={{
                  width: 50,
                  height: 50,
            ...
            <ListView
              dataSource={this.dataSource.cloneWithRows(this.state.selectedTag)}
              renderRow={this.renderRowTag.bind(this)}
              rowHeight={60}
              contentContainerStyle={{ height: 60, backgroundColor: "white" }}
              enableEmptySections={true}
              horizontal={true}
            />
          </View>
