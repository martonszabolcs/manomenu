...
export default class Receptek extends Component<{}> {
  ...
  render() {
    ...
    return (
      ...
      <View style={{width:width, height:height/15, backgroundColor:'transparent', flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end',paddingBottom:10}}>
