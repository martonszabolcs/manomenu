  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View>
          <Image
            source={require("../src/hozzataplalas/hozzatapl_n_azalap.png")}
        ...
        >
          <ListView
            dataSource={this.dataSource.cloneWithRows(this.state.alapok)}
