...
export default class Alapanyag extends Component<{}> {
  constructor(props) {
    console.log(props);
    super(props);
    this.state = {
  ...
  componentWillMount() {
    ...
    api.getGyumolcs().then(gyumolcs => {
      this.setState({
        gyumolcs: gyumolcs.list.reverse()
      });
    });

    api.getTeszta().then(teszta => {
      this.setState({
        teszta: teszta.list.reverse()
      });
    });

    api.getHus().then(hus => {
      this.setState({
        hus: hus.list.reverse()
      });
    });

    api.getTojas().then(tojas => {
      this.setState({
        tojas: tojas.list.reverse()
      });
    });

    api.getHal().then(hal => {
      this.setState({
        hal: hal.list.reverse()
      });
    });

    api.getTejtermekek().then(tejtermekek => {
      this.setState({
        tejtermekek: tejtermekek.list.reverse()
      });
    });
        ...
        >
          <View style={styles.slide}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Text style={styles.nameText}>{"ZÖLDSÉG"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"GYÜMÖLCS"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"TÉSZTA"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"HÚS"}</Text>
                  </View>
                </TouchableOpacity>
              </View>
              <View
              ...
              >
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"TOJÁS"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"HAL"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"TEJTERMÉKEK"}</Text>
                  </View>
                </TouchableOpacity>
            ...
            <ScrollView style={{ backgroundColor: "white" }}>
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.zoldseg)}
          ...
          <View style={styles.slide}>
            ...
            <ScrollView style={{ backgroundColor: "white" }}>
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.gyumolcs)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
          ...
          <View style={styles.slide}>
            ...
            <ScrollView style={{ backgroundColor: "white" }}>
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.teszta)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
          ...
          <View style={styles.slide}>
            ...
            <ScrollView style={{ backgroundColor: "white" }}>
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.hus)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
          ...
          <View style={styles.slide}>
            ...
            <ScrollView style={{ backgroundColor: "white" }}>
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.tojas)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
          ...
          <View style={styles.slide}>
            ...
            <ScrollView style={{ backgroundColor: "white" }}>
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.hal)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
