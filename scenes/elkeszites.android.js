...
export default class Elkeszites extends Component<{}> {
  constructor(props) {
    console.log(props);
    super(props);
    this.state = {
  ...
  componentWillMount() {
    api.getParolt().then(parolt => {
      this.setState({
        parolt: parolt.list.reverse()
      });

      api.getSult().then(sult => {
        this.setState({
          sult: sult.list.reverse()
        });
      });

      api.getFott().then(fott => {
        this.setState({
          fott: fott.list.reverse()
        });
      });

      api.getFagyasztott().then(fagyasztott => {
        this.setState({
          fagyasztott: fagyasztott.list.reverse()
        });
      });

      api.getNyers().then(nyers => {
        this.setState({
          nyers: nyers.list.reverse()
        });
      });

      api.getGrillezett().then(grillezett => {
        this.setState({
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.slide}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Text style={styles.nameText}>{"SÜLT"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"PÁROLT"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"FŐTT"}</Text>
                  </View>
                </TouchableOpacity>
              </View>
              <View
              ...
              >
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"FAGYASZTOTT"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"NYERS"}</Text>
                  </View>
                </TouchableOpacity>
                ...
                >
                  <View style={{ margin: "auto" }}>
                    <Text style={styles.nameText}>{"GRILLEZETT"}</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
            ...
            >
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.sult)}
          ...
          <View style={styles.slide}>
            ...
            >
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.parolt)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
          ...
          <View style={styles.slide}>
            ...
            >
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.fott)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
          ...
          <View style={styles.slide}>
            ...
            >
              <ListView
                dataSource={this.dataSource.cloneWithRows(this.state.nyers)}
                enableEmptySections={true}
                initialListSize={10}
                contentContainerStyle={styles.list}
                scrollEnabled={true}
