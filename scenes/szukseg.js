...
export default class Szukseg extends Component<{}> {
  constructor(props) {
    super(props);
    this.state = {
      postCover: [],
  ...
  componentWillMount() {
    api.getSzukseg().then(szukseg => {
      this.setState({
        szukseg: szukseg.list
      });
    });
  }
  ...
  render() {
    ...
    console.log(this.state.szukseg);
    return (
      <View style={styles.container}>
        ...
        <View>
          <Image
            source={require("../src/hozzataplalas/hozzatapl_n_mierelesz.png")}
        ...
        >
          <ListView
            dataSource={this.dataSource.cloneWithRows(this.state.szukseg)}
